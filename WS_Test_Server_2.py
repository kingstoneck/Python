...
#https://stackoverflow.com/questions/32401707/simple-websocket-server-on-python-using-time-sleep
#https://github.com/dpallot/simple-websocket-server
#https://github.com/dpallot/simple-websocket-server/blob/a6ddef766a4f5fa655c9072107fccc28ecf2b3e3/SimpleWebSocketServer/SimpleWebSocketServer.py#L84
...
class SimpleWebSocketServer(object):
	...
	def _handleClose(self, client):
		client.client.close()  # only call handleClose when we have a successful websocket connection
